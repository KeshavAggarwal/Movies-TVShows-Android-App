...
public class RecyclerViewAdapterTVShowCast extends RecyclerView.Adapter<RecyclerViewAdapterTVShowCast.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (mTvShowCast != null) {
            ...
            Picasso.get().load(URLConstants.IMAGE_BASE_URL + mTvShowCast.get(position).getProfile_path()).into(holder.tvshowCastImage);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            tvshowCastImage = itemView.findViewById(R.id.tvshowCastImage);
            tvshowCastName = itemView.findViewById(R.id.tvshowCastName);
            tvshowCastCharacter = itemView.findViewById(R.id.tvshowCastCharacter);
            tvshowCastDivider = itemView.findViewById(R.id.tvshowCastDivider);
