...
public class RecyclerViewAdapterReviews extends RecyclerView.Adapter<RecyclerViewAdapterReviews.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            reviewsCardView = itemView.findViewById(R.id.reviewCardView);
            reviewTextView = itemView.findViewById(R.id.reviewsTextView);
            reviewHeading = itemView.findViewById(R.id.reviewHeading);
            circleTextView = itemView.findViewById(R.id.circleTextView);
            reviewSubheading = itemView.findViewById(R.id.reviewSubheading);
            readTheRestTextView = itemView.findViewById(R.id.readtheRestTextView);
        }
    }
