...
public class RecyclerViewAdapterMovieCast extends RecyclerView.Adapter<RecyclerViewAdapterMovieCast.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (mMovieCast != null) {
            ...
            Picasso.get().load(URLConstants.IMAGE_BASE_URL + mMovieCast.get(position).getProfile_path()).into(holder.movieCastImage);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            movieCastImage = itemView.findViewById(R.id.movieCastImage);
            movieCastName = itemView.findViewById(R.id.movieCastName);
            movieCastCharacter = itemView.findViewById(R.id.moviCastCharacter);
            movieCastDivider = itemView.findViewById(R.id.movieCastDivider);
